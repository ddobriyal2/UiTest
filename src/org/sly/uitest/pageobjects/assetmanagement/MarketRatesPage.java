 ...
 * accessed by clicking 'Build -> 'Market Rates' In material view , it can be
 * accessed by clicking 'Asset Management -> 'Market Rates'
 * 
 * @author Benny Leung
 * @date : 9 Aug, 2016
 * @company Prive Financial
 */
public class MarketRatesPage extends AbstractPage {

	public MarketRatesPage(WebDriver webDriver) {
